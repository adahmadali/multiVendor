									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('register') }}">
											...
											<div class="col-12">
												...
												<input type="text"  name="name" class="form-control" id="inputLastName" placeholder="Ahmad Ali">
											...
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label">Phone No</label>
												<input type="text" name="phone" class="form-control" id="inputEmailAddress" placeholder="example@user.com">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input name="password_confirmation" type="password" class="form-control border-end-0" id="inputChoosePassword" value="12345678" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
