					...
					<div class="main-body">
						<div class="row">
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											<img src="{{(!empty($vendorInfo->User_pic))? asset('uploads/vendor/'.$vendorInfo->User_pic) : asset('uploads/admin/admin.png') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
											<div class="mt-3">
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
										<form action="{{route('vendor.profile.update',$vendorInfo->id)}}" method="post" enctype="multipart/form-data">
											@csrf
											<div class="row mb-3">
												<div class="col-sm-3">
											...
											<div class="row mb-3">
												...
												<div class="col-sm-9 text-secondary">
													...
													src="{{(!empty($vendorInfo->User_pic))? asset('uploads/vendor/'.$vendorInfo->User_pic) : asset('uploads/admin/admin.png') }}" alt="">
												</div>
											</div>
											<div class="row">
