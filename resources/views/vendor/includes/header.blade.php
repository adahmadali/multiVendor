				...
				<p class="msg-info">Your new product has approved</p>
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{(!empty(Auth::user()->User_pic))? asset('uploads/vendor/'.Auth::user()->User_pic) : asset('uploads/admin/admin.png') }}" class="user-img" alt="user avatar">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item" href="{{route('vendor.change.password')}}"><i class='bx bx-dollar-circle'></i><span>Change Password</span></a>
							</li>
